    ...
    <header className="bg-white border-b sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <img src="/logo.png" alt="EPO" className="h-7 md:h-8 w-auto shrink-0" />
          <div className="leading-tight min-w-0">
            <div className="font-semibold tracking-wide text-lg md:text-sm truncate">EASTERN PANORAMA OFFSET</div>
            <div className="text-[10px] font-bold tracking-wide text-gray-500 truncate">Igniting Ideas &amp; Solutions, Across Borders.</div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:block text-right mr-2">
            <div className="text-xs font-bold text-gray-600">{user?.username}</div>
            <div className="text-[10px] font-bold text-gray-400">{user?.role} · {user?.department}</div>
          </div>
          <button
